...
async function submitPesanan() {
    ...
    formData.append('menu_nama', menuDipilih ? menuDipilih.nama : 'Unknown');
    formData.append('jumlah', jumlah);
    formData.append('alamat', alamat);
    formData.append('pengiriman', pengiriman);
    formData.append('pembayaran', pembayaran);
    formData.append('catatan', catatan);
    formData.append('total_harga', total);

    try {
        const response = await fetch('../backend/orders/checkout_process.php', {
            method: 'POST',
            body: formData
        });
